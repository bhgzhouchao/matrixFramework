...
import org.matrix.framework.core.platform.web.cache.Header.Type;
...
public class GenericResponseWrapper extends HttpServletResponseWrapper {
    ...
    public void sendError(int statusCode, String string) throws IOException {
        this.statusCode = statusCode;
        super.sendError(statusCode, string);
    }
    ...
    public void setStatus(final int statusCode, final String msg) {
        this.statusCode = statusCode;
