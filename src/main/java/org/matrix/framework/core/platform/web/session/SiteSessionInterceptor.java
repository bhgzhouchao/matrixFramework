...
public class SiteSessionInterceptor extends HandlerInterceptorAdapter {
    ...
    private void generatedSessionKey() {
        final String sessionId = ssoSettings.getSecondclientKey();
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (!Boolean.TRUE.equals(initialized)) {
            loadSession(MatrixMemcachedGroup.SECOND_SESSIONGROUP, sessionContext, cookieSessionId);
            if (request.isSecure()) {
                secureSessionContext.underSecureRequest();
                loadSession(MatrixMemcachedGroup.SECOND_SESSIONGROUP, secureSessionContext, cookieSecureSessionId);
            }
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        saveAllSessions(MatrixMemcachedGroup.SECOND_SESSIONGROUP, request);
    }
