...
public class CDNTagSupport extends TagSupport {
    ...
    String constructCDNPrefix(String url) {
        if (!supportCDN()) return constructLocalURL(url, true);
    ...
    String constructCDNURL(String url) {
        ...
        StringBuilder builder = new StringBuilder();
        builder.append(constructCDNPrefix(url))
               .append(connector)
               .append("version=")
               .append(siteSettings.getVersion());
        return builder.toString();
    }
    ...
    String buildMultipleResourceTags(String srcKey, String resourceDir, String tagTemplate, Map<String, Object> params) throws IOException,
